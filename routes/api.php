...
Route::middleware('api')->prefix('monitoring')->group(function () {
     ...
     * HARUS sebelum /{deviceId} agar tidak dianggap sebagai deviceId wildcard!
     */
    ...
    /**
     * Get chart data untuk real-time chart (suhu & kelembaban dari DHT11)
     * 
    ...
    /**
     * Get latest monitoring data for a device (HARUS paling bawah - wildcard!)
     * 
